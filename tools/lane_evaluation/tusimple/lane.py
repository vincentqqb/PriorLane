...
class LaneEval(object):
    ...
    def bench(pred, gt, y_samples, running_time, get_matches=False):
        pred = [p[len(p)-len(y_samples):] for p in pred]
    ...
    def bench_one_submit(pred_file, gt_file):
        f_bad = open("/home/vincent/work/seqlane/SegFormer-master/eval/wsp_6/bad.txt", "w")
...
if __name__ == '__main__':
    res = LaneEval.bench_one_submit("path_to_pred.json", ["path_to_gt.json"])
    print(res)